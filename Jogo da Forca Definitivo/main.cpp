...
int main(int argc, char *argv[]){
    ...
    bool achou;
    char palavras[20][20]={"celular","smartphone","iphone","samsung","motorola","xiaomi","android","ios","tela","touchscreen","portatil","eletronico","chip","camera","Touchscreen","mensagem","ligacao","aparelho","wifi","bluetooth"};             
    ...
    while (r=='S'||r=='s'){
          ...
          while(tentativas>0 && acertos < tolletras){
            ...
            if(acertos == tolletras){
               std::cout<<"Parabens, voce acertou, a palavra era: "<<palavraSO<<"\n";
            }else{
